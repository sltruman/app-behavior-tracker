...
//!	Generated Date	: Fri, 17, Apr 2015 
	File Path	: DefaultComponent/DefaultConfig/android/app/Activity.java
*********************************************************************/
...
//## dependency Parcelable 
import android.os.Parcelable;
//## dependency StrictMode 
import android.os.StrictMode;
//## dependency UserHandle 
...
//## dependency MotionEvent 
import android.view.MotionEvent;
//## dependency SparseArray 
import android.util.SparseArray;
//## dependency ViewManager 
import android.view.ViewManager;
//## dependency AttributeSet 
import android.util.AttributeSet;
//## dependency MenuInflater 
import android.view.MenuInflater;
//## dependency AdapterView 
import android.widget.AdapterView;
//## dependency AudioManager 
import android.media.AudioManager;
//## dependency RemoteException 
import android.os.RemoteException;
//## dependency WindowManager 
import android.view.WindowManager;
//## dependency LayoutInflater 
import android.view.LayoutInflater;
//## dependency CursorLoader 
import android.content.CursorLoader;
//## dependency IntentSender 
import android.content.IntentSender;
//## dependency ComponentName 
import android.content.ComponentName;
//## dependency IIntentSender 
import android.content.IIntentSender;
//## dependency Resources 
import android.content.res.Resources;
//## dependency TypedArray 
import android.content.res.TypedArray;
//## dependency ActivityInfo 
import android.content.pm.ActivityInfo;
//## dependency ContentResolver 
import android.content.ContentResolver;
//## dependency ContextThemeWrapper 
import android.view.ContextThemeWrapper;
//## dependency WindowManagerGlobal 
import android.view.WindowManagerGlobal;
//## dependency Configuration 
import android.content.res.Configuration;
//## dependency PackageManager 
import android.content.pm.PackageManager;
//## dependency SharedPreferences 
import android.content.SharedPreferences;
//## dependency Drawable 
import android.graphics.drawable.Drawable;
//## dependency ComponentCallbacks2 
import android.content.ComponentCallbacks2;
//## dependency SpannableStringBuilder 
import android.text.SpannableStringBuilder;
//## dependency TextKeyListener 
import android.text.method.TextKeyListener;
//## dependency LayoutParams 
import android.view.ViewGroup.LayoutParams;
//## auto_generated
import com.ibm.rational.rhapsody.animation.*;
//## dependency ActionBarImpl 
import com.android.internal.app.ActionBarImpl;
//## dependency ContextMenuInfo 
import android.view.ContextMenu.ContextMenuInfo;
//## dependency PolicyManager 
import com.android.internal.policy.PolicyManager;
//## dependency AccessibilityEvent 
import android.view.accessibility.AccessibilityEvent;
//## dependency OnCreateContextMenuListener 
import android.view.View.OnCreateContextMenuListener;
//## auto_generated
import com.ibm.rational.rhapsody.animcom.animMessages.*;
//## dependency NameNotFoundException 
...
*/
//## class Activity 
public class Activity extends ContextThemeWrapper implements Animated, LayoutInflater.Factory2, Window.Callback, KeyEvent.Callback, OnCreateContextMenuListener, ComponentCallbacks2 {
    
    //#[ ignore
    // Instrumentation attributes (Animation)
    private Animate animate;
    
    public static AnimClass animClassActivity = new AnimClass("android.app.Activity",false);
    public static AnimClass animClassActivity$ManagedDialog = new AnimClass("android.app.Activity$ManagedDialog",false);
    public static AnimClass animClassActivity$NonConfigurationInstances = new AnimClass("android.app.Activity$NonConfigurationInstances",false);
    public static AnimClass animClassActivity$ManagedCursor = new AnimClass("android.app.Activity$ManagedCursor",false);
    //#]
    
    private static final String TAG = "Activity";		//## attribute TAG 
    
    private static final boolean DEBUG_LIFECYCLE = false;		//## attribute DEBUG_LIFECYCLE 
    
    /**
     * Standard activity result: operation canceled. 
    */
    public static final int RESULT_CANCELED = 0;		//## attribute RESULT_CANCELED 
    
    /**
     * Standard activity result: operation succeeded. 
    */
    public static final int RESULT_OK = -1;		//## attribute RESULT_OK 
    
    /**
     * Start of user-defined activity results. 
    */
    public static final int RESULT_FIRST_USER = 1;		//## attribute RESULT_FIRST_USER 
    
    static final String FRAGMENTS_TAG = "android:fragments";		//## attribute FRAGMENTS_TAG 
    
    private static final String WINDOW_HIERARCHY_TAG = "android:viewHierarchyState";		//## attribute WINDOW_HIERARCHY_TAG 
    
    private static final String SAVED_DIALOG_IDS_KEY = "android:savedDialogIds";		//## attribute SAVED_DIALOG_IDS_KEY 
    
    private static final String SAVED_DIALOGS_TAG = "android:savedDialogs";		//## attribute SAVED_DIALOGS_TAG 
    
    private static final String SAVED_DIALOG_KEY_PREFIX = "android:dialog_";		//## attribute SAVED_DIALOG_KEY_PREFIX 
    
    private static final String SAVED_DIALOG_ARGS_KEY_PREFIX = "android:dialog_args_";		//## attribute SAVED_DIALOG_ARGS_KEY_PREFIX 
    
    private SparseArray<Activity.ManagedDialog> mManagedDialogs;		//## attribute mManagedDialogs 
    
    /**
     * set by the thread after the constructor and before onCreate(Bundle savedInstanceState) is called.
    */
    private Instrumentation mInstrumentation;		//## attribute mInstrumentation 
    
    private int mIdent;		//## attribute mIdent 
    
    /**
     * package
    */
    String mEmbeddedID;		//## attribute mEmbeddedID 
    
    private Application mApplication;		//## attribute mApplication 
    
    /**
     * package
    */
    ActivityThread mMainThread;		//## attribute mMainThread 
    
    boolean mCalled;		//## attribute mCalled 
    
    boolean mCheckedForLoaderManager;		//## attribute mCheckedForLoaderManager 
    
    boolean mLoadersStarted;		//## attribute mLoadersStarted 
    
    /**
     * package
    */
    boolean mResumed;		//## attribute mResumed 
    
    private boolean mStopped;		//## attribute mStopped 
    
    boolean mFinished;		//## attribute mFinished 
    
    boolean mStartedActivity;		//## attribute mStartedActivity 
    
    private boolean mDestroyed;		//## attribute mDestroyed 
    
    /**
     * true if the activity is going through a transient pause package
    */
    boolean mTemporaryPause = false;		//## attribute mTemporaryPause 
    
    /**
     * true if the activity is being destroyed in order to recreate it with a new configuration package
    */
    boolean mChangingConfigurations = false;		//## attribute mChangingConfigurations 
    
    /**
     * package
    */
    int mConfigChangeFlags;		//## attribute mConfigChangeFlags 
    
    private SearchManager mSearchManager;		//## attribute mSearchManager 
    
    /**
     * package
    */
    View mDecor = null;		//## attribute mDecor 
    
    /**
     * package
    */
    boolean mWindowAdded = false;		//## attribute mWindowAdded 
    
    /**
     * package
    */
    boolean mVisibleFromServer = false;		//## attribute mVisibleFromServer 
    
    /**
     * package
    */
    boolean mVisibleFromClient = true;		//## attribute mVisibleFromClient 
    
    /**
     * package
    */
    ActionBarImpl mActionBar = null;		//## attribute mActionBar 
    
    private boolean mEnableDefaultActionBarUp;		//## attribute mEnableDefaultActionBarUp 
    
    private CharSequence mTitle;		//## attribute mTitle 
    
    private int mTitleColor = 0;		//## attribute mTitleColor 
    
    final FragmentManagerImpl mFragments = new FragmentManagerImpl();		//## attribute mFragments 
    ...
    };		//## attribute mContainer 
    
    HashMap<String, LoaderManagerImpl> mAllLoaderManagers;		//## attribute mAllLoaderManagers 
    
    LoaderManagerImpl mLoaderManager;		//## attribute mLoaderManager 
    
    private final ArrayList<Activity.ManagedCursor> mManagedCursors = new ArrayList<ManagedCursor>();		//## attribute mManagedCursors 
    
    /**
     * protected by synchronized (this) 
    */
    int mResultCode = RESULT_CANCELED;		//## attribute mResultCode 
    
    Intent mResultData = null;		//## attribute mResultData 
    
    private boolean mTitleReady = false;		//## attribute mTitleReady 
    
    private int mDefaultKeyMode = DEFAULT_KEYS_DISABLE;		//## attribute mDefaultKeyMode 
    
    private SpannableStringBuilder mDefaultKeySsb = null;		//## attribute mDefaultKeySsb 
    
    protected static final int[] FOCUSED_STATE_SET = {com.android.internal.R.attr.state_focused};		//## attribute FOCUSED_STATE_SET 
    
    @SuppressWarnings("unused")
    private final Object mInstanceTracker = StrictMode.trackActivity(this);		//## attribute mInstanceTracker 
    
    private Thread mUiThread;		//## attribute mUiThread 
    
    final Handler mHandler = new Handler();		//## attribute mHandler 
    ...
    */
    public static final int DEFAULT_KEYS_DISABLE = 0;		//## attribute DEFAULT_KEYS_DISABLE 
     ...
     * @see #setDefaultKeyMode
    */
    public static final int DEFAULT_KEYS_DIALER = 1;		//## attribute DEFAULT_KEYS_DIALER 
     ...
     * @see #setDefaultKeyMode
    */
    public static final int DEFAULT_KEYS_SHORTCUT = 2;		//## attribute DEFAULT_KEYS_SHORTCUT 
     ...
     * @see #setDefaultKeyMode
    */
    public static final int DEFAULT_KEYS_SEARCH_LOCAL = 3;		//## attribute DEFAULT_KEYS_SEARCH_LOCAL 
     ...
     * @see #setDefaultKeyMode
    */
    public static final int DEFAULT_KEYS_SEARCH_GLOBAL = 4;		//## attribute DEFAULT_KEYS_SEARCH_GLOBAL 
    
    private IBinder mToken;		//## link mToken 
    
    /**
     * package
    */
    Intent mIntent;		//## link mIntent 
    
    private ComponentName mComponent;		//## link mComponent 
    
    /**
     * package
    */
    ActivityInfo mActivityInfo;		//## link mActivityInfo 
    
    Activity mParent;		//## link mParent 
    
    /**
     * package
    */
    Configuration mCurrentConfig;		//## link mCurrentConfig 
    
    private MenuInflater mMenuInflater;		//## link mMenuInflater 
    
    /**
     * package 
    */
    Activity.NonConfigurationInstances mLastNonConfigurationInstances;		//## link mLastNonConfigurationInstances 
    
    private Window mWindow;		//## link mWindow 
    
    private WindowManager mWindowManager;		//## link mWindowManager 
    ...
    */
    ...
    public Intent  getIntent() {
        try {
            animInstance().notifyMethodEntered("getIntent",
               new ArgData[] {
               });
     ...
     * @param newIntent
    */
    //## operation setIntent(Intent) 
    public void setIntent(Intent newIntent) {
        try {
            animInstance().notifyMethodEntered("setIntent",
               new ArgData[] {
                   new ArgData(Intent.class, "newIntent", AnimInstance.animToString(newIntent))
               });
    ...
    */
    ...
    public final Application  getApplication() {
        try {
            animInstance().notifyMethodEntered("getApplication",
               new ArgData[] {
               });
    ...
    */
    ...
    public final boolean isChild() {
        try {
            animInstance().notifyMethodEntered("isChild",
               new ArgData[] {
               });
    ...
    */
    ...
    public final Activity  getParent() {
        try {
            animInstance().notifyMethodEntered("getParent",
               new ArgData[] {
               });
    ...
    */
    //## operation getWindowManager() 
    public WindowManager  getWindowManager() {
        try {
            animInstance().notifyMethodEntered("getWindowManager",
               new ArgData[] {
               });
    ...
    */
    ...
    public Window  getWindow() {
        try {
            animInstance().notifyMethodEntered("getWindow",
               new ArgData[] {
               });
    ...
    */
    //## operation getLoaderManager() 
    public LoaderManager  getLoaderManager() {
        try {
            animInstance().notifyMethodEntered("getLoaderManager",
               new ArgData[] {
               });
     ...
     * @param create
    */
    //## operation getLoaderManager(String,boolean,boolean) 
    LoaderManagerImpl  getLoaderManager(String who, boolean started, boolean create) {
        try {
            animInstance().notifyMethodEntered("getLoaderManager",
               new ArgData[] {
                   new ArgData(String.class, "who", AnimInstance.animToString(who)),
                   new ArgData(boolean.class, "started", AnimInstance.animToString(started)),
                   new ArgData(boolean.class, "create", AnimInstance.animToString(create))
               });
    ...
    */
    //## operation getCurrentFocus() 
    public View  getCurrentFocus() {
        try {
            animInstance().notifyMethodEntered("getCurrentFocus",
               new ArgData[] {
               });
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            animInstance().notifyMethodEntered("onCreate",
               new ArgData[] {
                   new ArgData(Bundle.class, "savedInstanceState", AnimInstance.animToString(savedInstanceState))
               });
     ...
     * @param savedInstanceState
    */
    //## operation performRestoreInstanceState(Bundle) 
    final void performRestoreInstanceState(Bundle savedInstanceState) {
        try {
            animInstance().notifyMethodEntered("performRestoreInstanceState",
               new ArgData[] {
                   new ArgData(Bundle.class, "savedInstanceState", AnimInstance.animToString(savedInstanceState))
               });
     ...
     * @param savedInstanceState
    */
    //## operation onRestoreInstanceState(Bundle) 
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        try {
            animInstance().notifyMethodEntered("onRestoreInstanceState",
               new ArgData[] {
                   new ArgData(Bundle.class, "savedInstanceState", AnimInstance.animToString(savedInstanceState))
               });
     ...
     * @param savedInstanceState
    */
    //## operation restoreManagedDialogs(Bundle) 
    private void restoreManagedDialogs(Bundle savedInstanceState) {
        try {
            animInstance().notifyMethodEntered("restoreManagedDialogs",
               new ArgData[] {
                   new ArgData(Bundle.class, "savedInstanceState", AnimInstance.animToString(savedInstanceState))
               });
     ...
     * @param args
    */
    //## operation createDialog(Integer,Bundle,Bundle) 
    private Dialog  createDialog(Integer dialogId, Bundle state, Bundle args) {
        try {
            animInstance().notifyMethodEntered("createDialog",
               new ArgData[] {
                   new ArgData(Integer.class, "dialogId", AnimInstance.animToString(dialogId)),
                   new ArgData(Bundle.class, "state", AnimInstance.animToString(state)),
                   new ArgData(Bundle.class, "args", AnimInstance.animToString(args))
               });
     ...
     * @param key
    */
    //## operation savedDialogKeyFor(int) 
    private static String savedDialogKeyFor(int key) {
        try {
            animClassActivity.notifyMethodEntered("savedDialogKeyFor",
               new ArgData[] {
                   new ArgData(int.class, "key", AnimInstance.animToString(key))
               });
        ...
        //#]
            ...
            animClassActivity.notifyMethodExit();
        }
     ...
     * @param key
    */
    //## operation savedDialogArgsKeyFor(int) 
    private static String savedDialogArgsKeyFor(int key) {
        try {
            animClassActivity.notifyMethodEntered("savedDialogArgsKeyFor",
               new ArgData[] {
                   new ArgData(int.class, "key", AnimInstance.animToString(key))
               });
     ...
     * @param savedInstanceState
    */
    //## operation onPostCreate(Bundle) 
    protected void onPostCreate(Bundle savedInstanceState) {
        try {
            animInstance().notifyMethodEntered("onPostCreate",
               new ArgData[] {
                   new ArgData(Bundle.class, "savedInstanceState", AnimInstance.animToString(savedInstanceState))
               });
    ...
    */
    ...
    protected void onStart() {
        try {
            animInstance().notifyMethodEntered("onStart",
               new ArgData[] {
               });
    ...
    */
    ...
    protected void onRestart() {
        try {
            animInstance().notifyMethodEntered("onRestart",
               new ArgData[] {
               });
    ...
    */
    ...
    protected void onResume() {
        try {
            animInstance().notifyMethodEntered("onResume",
               new ArgData[] {
               });
     ...
     * @see #onResume
    */
    //## operation onPostResume() 
    protected void onPostResume() {
        try {
            animInstance().notifyMethodEntered("onPostResume",
               new ArgData[] {
               });
     ...
     * @param intent
    */
    //## operation onNewIntent(Intent) 
    protected void onNewIntent(Intent intent) {
        try {
            animInstance().notifyMethodEntered("onNewIntent",
               new ArgData[] {
                   new ArgData(Intent.class, "intent", AnimInstance.animToString(intent))
               });
     ...
     * @param outState
    */
    //## operation performSaveInstanceState(Bundle) 
    final void performSaveInstanceState(Bundle outState) {
        try {
            animInstance().notifyMethodEntered("performSaveInstanceState",
               new ArgData[] {
                   new ArgData(Bundle.class, "outState", AnimInstance.animToString(outState))
               });
     ...
     * @param outState
    */
    //## operation onSaveInstanceState(Bundle) 
    protected void onSaveInstanceState(Bundle outState) {
        try {
            animInstance().notifyMethodEntered("onSaveInstanceState",
               new ArgData[] {
                   new ArgData(Bundle.class, "outState", AnimInstance.animToString(outState))
               });
     ...
     * @param outState
    */
    //## operation saveManagedDialogs(Bundle) 
    private void saveManagedDialogs(Bundle outState) {
        try {
            animInstance().notifyMethodEntered("saveManagedDialogs",
               new ArgData[] {
                   new ArgData(Bundle.class, "outState", AnimInstance.animToString(outState))
               });
    ...
    */
    ...
    protected void onPause() {
        try {
            animInstance().notifyMethodEntered("onPause",
               new ArgData[] {
               });
    ...
    */
    //## operation onUserLeaveHint() 
    protected void onUserLeaveHint() {
        try {
            animInstance().notifyMethodEntered("onUserLeaveHint",
               new ArgData[] {
               });
     ...
     * @param canvas
    */
    //## operation onCreateThumbnail(Bitmap,Canvas) 
    public boolean onCreateThumbnail(Bitmap outBitmap, Canvas canvas) {
        try {
            animInstance().notifyMethodEntered("onCreateThumbnail",
               new ArgData[] {
                   new ArgData(Bitmap.class, "outBitmap", AnimInstance.animToString(outBitmap)),
                   new ArgData(Canvas.class, "canvas", AnimInstance.animToString(canvas))
               });
     ...
     * @see #onPause
    */
    //## operation onCreateDescription() 
    public CharSequence  onCreateDescription() {
        try {
            animInstance().notifyMethodEntered("onCreateDescription",
               new ArgData[] {
               });
    ...
    */
    ...
    protected void onStop() {
        try {
            animInstance().notifyMethodEntered("onStop",
               new ArgData[] {
               });
    ...
    */
    ...
    protected void onDestroy() {
        try {
            animInstance().notifyMethodEntered("onDestroy",
               new ArgData[] {
               });
     ...
     * @param newConfig
    */
    //## operation onConfigurationChanged(Configuration) 
    public void onConfigurationChanged(Configuration newConfig) {
        try {
            animInstance().notifyMethodEntered("onConfigurationChanged",
               new ArgData[] {
                   new ArgData(Configuration.class, "newConfig", AnimInstance.animToString(newConfig))
               });
     ...
     * class.
    */
    //## operation getChangingConfigurations() 
    public int getChangingConfigurations() {
        try {
            animInstance().notifyMethodEntered("getChangingConfigurations",
               new ArgData[] {
               });
    ...
    @Deprecated
    //## operation getLastNonConfigurationInstance() 
    public Object getLastNonConfigurationInstance() {
        try {
            animInstance().notifyMethodEntered("getLastNonConfigurationInstance",
               new ArgData[] {
               });
    ...
    */
    //## operation onRetainNonConfigurationInstance() 
    public Object onRetainNonConfigurationInstance() {
        try {
            animInstance().notifyMethodEntered("onRetainNonConfigurationInstance",
               new ArgData[] {
               });
    ...
    */
    //## operation getLastNonConfigurationChildInstances() 
    HashMap<String, Object>  getLastNonConfigurationChildInstances() {
        try {
            animInstance().notifyMethodEntered("getLastNonConfigurationChildInstances",
               new ArgData[] {
               });
    ...
    */
    //## operation onRetainNonConfigurationChildInstances() 
    HashMap<String, Object>  onRetainNonConfigurationChildInstances() {
        try {
            animInstance().notifyMethodEntered("onRetainNonConfigurationChildInstances",
               new ArgData[] {
               });
    ...
    //## operation retainNonConfigurationInstances() 
    Activity.NonConfigurationInstances  retainNonConfigurationInstances() {
        try {
            animInstance().notifyMethodEntered("retainNonConfigurationInstances",
               new ArgData[] {
               });
    ...
    //## operation onLowMemory() 
    public void onLowMemory() {
        try {
            animInstance().notifyMethodEntered("onLowMemory",
               new ArgData[] {
               });
     ...
     * @param level
    */
    //## operation onTrimMemory(int) 
    public void onTrimMemory(int level) {
        try {
            animInstance().notifyMethodEntered("onTrimMemory",
               new ArgData[] {
                   new ArgData(int.class, "level", AnimInstance.animToString(level))
               });
     ...
     * with this activity.
    */
    //## operation getFragmentManager() 
    public FragmentManager  getFragmentManager() {
        try {
            animInstance().notifyMethodEntered("getFragmentManager",
               new ArgData[] {
               });
     ...
     * @param who
    */
    //## operation invalidateFragment(String) 
    void invalidateFragment(String who) {
        try {
            animInstance().notifyMethodEntered("invalidateFragment",
               new ArgData[] {
                   new ArgData(String.class, "who", AnimInstance.animToString(who))
               });
     ...
     * @param fragment
    */
    //## operation onAttachFragment(Fragment) 
    public void onAttachFragment(Fragment fragment) {
        try {
            animInstance().notifyMethodEntered("onAttachFragment",
               new ArgData[] {
                   new ArgData(Fragment.class, "fragment", AnimInstance.animToString(fragment))
               });
    ...
    */
    @Deprecated
    //## operation managedQuery(Uri,String[],String,String) 
    public final Cursor  managedQuery(Uri uri, String[] projection, String selection, String sortOrder) {
        try {
            animInstance().notifyMethodEntered("managedQuery",
               new ArgData[] {
                   new ArgData(Uri.class, "uri", AnimInstance.animToString(uri)),
                   new ArgData(String[].class, "projection", AnimInstance.animToString(projection)),
                   new ArgData(String.class, "selection", AnimInstance.animToString(selection)),
                   new ArgData(String.class, "sortOrder", AnimInstance.animToString(sortOrder))
               });
    ...
    */
    @Deprecated
    //## operation managedQuery(Uri,String[],String,String[],String) 
        ...
        try {
            animInstance().notifyMethodEntered("managedQuery",
               new ArgData[] {
                   ...
                   new ArgData(String[].class, "projection", AnimInstance.animToString(projection)),
                   new ArgData(String.class, "selection", AnimInstance.animToString(selection)),
                   new ArgData(String[].class, "selectionArgs", AnimInstance.animToString(selectionArgs)),
                   new ArgData(String.class, "sortOrder", AnimInstance.animToString(sortOrder))
               });
    ...
    */
    @Deprecated
    //## operation startManagingCursor(Cursor) 
    public void startManagingCursor(Cursor c) {
        try {
            animInstance().notifyMethodEntered("startManagingCursor",
               new ArgData[] {
                   new ArgData(Cursor.class, "c", AnimInstance.animToString(c))
               });
    ...
    */
    @Deprecated
    //## operation stopManagingCursor(Cursor) 
    public void stopManagingCursor(Cursor c) {
        try {
            animInstance().notifyMethodEntered("stopManagingCursor",
               new ArgData[] {
                   new ArgData(Cursor.class, "c", AnimInstance.animToString(c))
               });
    ...
    */
    @Deprecated
    //## operation setPersistent(boolean) 
    public void setPersistent(boolean isPersistent) {
        try {
            animInstance().notifyMethodEntered("setPersistent",
               new ArgData[] {
                   new ArgData(boolean.class, "isPersistent", AnimInstance.animToString(isPersistent))
               });
     ...
     * @param id
    */
    //## operation findViewById(int) 
    public View  findViewById(int id) {
        try {
            animInstance().notifyMethodEntered("findViewById",
               new ArgData[] {
    ...
    */
    //## operation getActionBar() 
    public ActionBar  getActionBar() {
        try {
            animInstance().notifyMethodEntered("getActionBar",
               new ArgData[] {
               });
    ...
    */
    //## operation initActionBar() 
    private void initActionBar() {
        try {
            animInstance().notifyMethodEntered("initActionBar",
               new ArgData[] {
               });
     ...
     * @param layoutResID
    */
    //## operation setContentView(int) 
    public void setContentView(int layoutResID) {
        try {
            animInstance().notifyMethodEntered("setContentView",
               new ArgData[] {
                   new ArgData(int.class, "layoutResID", AnimInstance.animToString(layoutResID))
               });
     ...
     * @param view
    */
    //## operation setContentView(View) 
    public void setContentView(View view) {
        try {
            animInstance().notifyMethodEntered("setContentView",
               new ArgData[] {
                   new ArgData(View.class, "view", AnimInstance.animToString(view))
               });
     ...
     * @param params
    */
    //## operation setContentView(View,ViewGroup.LayoutParams) 
    public void setContentView(View view, ViewGroup.LayoutParams params) {
        try {
            animInstance().notifyMethodEntered("setContentView",
               new ArgData[] {
                   new ArgData(View.class, "view", AnimInstance.animToString(view)),
                   new ArgData(ViewGroup.LayoutParams.class, "params", AnimInstance.animToString(params))
               });
     ...
     * @param params
    */
    //## operation addContentView(View,ViewGroup.LayoutParams) 
    public void addContentView(View view, ViewGroup.LayoutParams params) {
        try {
            animInstance().notifyMethodEntered("addContentView",
               new ArgData[] {
                   new ArgData(View.class, "view", AnimInstance.animToString(view)),
                   new ArgData(ViewGroup.LayoutParams.class, "params", AnimInstance.animToString(params))
               });
     ...
     * @param finish
    */
    //## operation setFinishOnTouchOutside(boolean) 
    public void setFinishOnTouchOutside(boolean finish) {
        try {
            animInstance().notifyMethodEntered("setFinishOnTouchOutside",
               new ArgData[] {
                   new ArgData(boolean.class, "finish", AnimInstance.animToString(finish))
               });
     ...
     * @param mode
    */
    //## operation setDefaultKeyMode(int) 
    public final void setDefaultKeyMode(int mode) {
        try {
            animInstance().notifyMethodEntered("setDefaultKeyMode",
               new ArgData[] {
                   new ArgData(int.class, "mode", AnimInstance.animToString(mode))
               });
     ...
     * @param event
    */
    //## operation onKeyDown(int,KeyEvent) 
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        try {
            animInstance().notifyMethodEntered("onKeyDown",
               new ArgData[] {
                   new ArgData(int.class, "keyCode", AnimInstance.animToString(keyCode)),
                   new ArgData(KeyEvent.class, "event", AnimInstance.animToString(event))
               });
     ...
     * @param event
    */
    //## operation onKeyLongPress(int,KeyEvent) 
    public boolean onKeyLongPress(int keyCode, KeyEvent event) {
        try {
            animInstance().notifyMethodEntered("onKeyLongPress",
               new ArgData[] {
                   new ArgData(int.class, "keyCode", AnimInstance.animToString(keyCode)),
                   new ArgData(KeyEvent.class, "event", AnimInstance.animToString(event))
               });
     ...
     * @param event
    */
    //## operation onKeyUp(int,KeyEvent) 
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        try {
            animInstance().notifyMethodEntered("onKeyUp",
               new ArgData[] {
                   new ArgData(int.class, "keyCode", AnimInstance.animToString(keyCode)),
                   new ArgData(KeyEvent.class, "event", AnimInstance.animToString(event))
               });
     ...
     * @param event
    */
    //## operation onKeyMultiple(int,int,KeyEvent) 
    public boolean onKeyMultiple(int keyCode, int repeatCount, KeyEvent event) {
        try {
            animInstance().notifyMethodEntered("onKeyMultiple",
               new ArgData[] {
                   new ArgData(int.class, "keyCode", AnimInstance.animToString(keyCode)),
                   new ArgData(int.class, "repeatCount", AnimInstance.animToString(repeatCount)),
                   new ArgData(KeyEvent.class, "event", AnimInstance.animToString(event))
               });
    ...
    */
    //## operation onBackPressed() 
    public void onBackPressed() {
        try {
            animInstance().notifyMethodEntered("onBackPressed",
               new ArgData[] {
               });
     ...
     * @param event
    */
    //## operation onKeyShortcut(int,KeyEvent) 
    public boolean onKeyShortcut(int keyCode, KeyEvent event) {
        try {
            animInstance().notifyMethodEntered("onKeyShortcut",
               new ArgData[] {
                   new ArgData(int.class, "keyCode", AnimInstance.animToString(keyCode)),
                   new ArgData(KeyEvent.class, "event", AnimInstance.animToString(event))
               });
     ...
     * @param event
    */
    //## operation onTouchEvent(MotionEvent) 
    public boolean onTouchEvent(MotionEvent event) {
        try {
            animInstance().notifyMethodEntered("onTouchEvent",
               new ArgData[] {
                   new ArgData(MotionEvent.class, "event", AnimInstance.animToString(event))
               });
     ...
     * @param event
    */
    //## operation onTrackballEvent(MotionEvent) 
    public boolean onTrackballEvent(MotionEvent event) {
        try {
            animInstance().notifyMethodEntered("onTrackballEvent",
               new ArgData[] {
                   new ArgData(MotionEvent.class, "event", AnimInstance.animToString(event))
               });
     ...
     * @param event
    */
    //## operation onGenericMotionEvent(MotionEvent) 
    public boolean onGenericMotionEvent(MotionEvent event) {
        try {
            animInstance().notifyMethodEntered("onGenericMotionEvent",
               new ArgData[] {
                   new ArgData(MotionEvent.class, "event", AnimInstance.animToString(event))
               });
     ...
     * @see #onUserLeaveHint()
    */
    //## operation onUserInteraction() 
    public void onUserInteraction() {
        try {
            animInstance().notifyMethodEntered("onUserInteraction",
               new ArgData[] {
               });
     ...
     * @param params
    */
    //## operation onWindowAttributesChanged(WindowManager.LayoutParams) 
    public void onWindowAttributesChanged(WindowManager.LayoutParams params) {
        try {
            animInstance().notifyMethodEntered("onWindowAttributesChanged",
               new ArgData[] {
                   new ArgData(WindowManager.LayoutParams.class, "params", AnimInstance.animToString(params))
               });
    ...
    //## operation onContentChanged() 
    public void onContentChanged() {
        try {
            animInstance().notifyMethodEntered("onContentChanged",
               new ArgData[] {
               });
     ...
     * @param hasFocus
    */
    //## operation onWindowFocusChanged(boolean) 
    public void onWindowFocusChanged(boolean hasFocus) {
        try {
            animInstance().notifyMethodEntered("onWindowFocusChanged",
               new ArgData[] {
                   new ArgData(boolean.class, "hasFocus", AnimInstance.animToString(hasFocus))
               });
    ...
    */
    //## operation onAttachedToWindow() 
    public void onAttachedToWindow() {
        try {
            animInstance().notifyMethodEntered("onAttachedToWindow",
               new ArgData[] {
               });
    ...
    */
    //## operation onDetachedFromWindow() 
    public void onDetachedFromWindow() {
        try {
            animInstance().notifyMethodEntered("onDetachedFromWindow",
               new ArgData[] {
               });
    ...
    */
    //## operation hasWindowFocus() 
    public boolean hasWindowFocus() {
        try {
            animInstance().notifyMethodEntered("hasWindowFocus",
               new ArgData[] {
               });
     ...
     * @param event
    */
    //## operation dispatchKeyEvent(KeyEvent) 
    public boolean dispatchKeyEvent(KeyEvent event) {
        try {
            animInstance().notifyMethodEntered("dispatchKeyEvent",
               new ArgData[] {
                   new ArgData(KeyEvent.class, "event", AnimInstance.animToString(event))
               });
     ...
     * @param event
    */
    //## operation dispatchKeyShortcutEvent(KeyEvent) 
    public boolean dispatchKeyShortcutEvent(KeyEvent event) {
        try {
            animInstance().notifyMethodEntered("dispatchKeyShortcutEvent",
               new ArgData[] {
                   new ArgData(KeyEvent.class, "event", AnimInstance.animToString(event))
               });
     ...
     * @param ev
    */
    //## operation dispatchTouchEvent(MotionEvent) 
    public boolean dispatchTouchEvent(MotionEvent ev) {
        try {
            animInstance().notifyMethodEntered("dispatchTouchEvent",
               new ArgData[] {
                   new ArgData(MotionEvent.class, "ev", AnimInstance.animToString(ev))
               });
     ...
     * @param ev
    */
    //## operation dispatchTrackballEvent(MotionEvent) 
    public boolean dispatchTrackballEvent(MotionEvent ev) {
        try {
            animInstance().notifyMethodEntered("dispatchTrackballEvent",
               new ArgData[] {
                   new ArgData(MotionEvent.class, "ev", AnimInstance.animToString(ev))
               });
     ...
     * @param ev
    */
    //## operation dispatchGenericMotionEvent(MotionEvent) 
    public boolean dispatchGenericMotionEvent(MotionEvent ev) {
        try {
            animInstance().notifyMethodEntered("dispatchGenericMotionEvent",
               new ArgData[] {
                   new ArgData(MotionEvent.class, "ev", AnimInstance.animToString(ev))
               });
     ...
     * @param event
    */
    //## operation dispatchPopulateAccessibilityEvent(AccessibilityEvent) 
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        try {
            animInstance().notifyMethodEntered("dispatchPopulateAccessibilityEvent",
               new ArgData[] {
                   new ArgData(AccessibilityEvent.class, "event", AnimInstance.animToString(event))
               });
     ...
     * @param featureId
    */
    //## operation onCreatePanelView(int) 
    public View  onCreatePanelView(int featureId) {
        try {
            animInstance().notifyMethodEntered("onCreatePanelView",
               new ArgData[] {
                   new ArgData(int.class, "featureId", AnimInstance.animToString(featureId))
               });
     ...
     * @param menu
    */
    //## operation onCreatePanelMenu(int,Menu) 
    public boolean onCreatePanelMenu(int featureId, Menu menu) {
        try {
            animInstance().notifyMethodEntered("onCreatePanelMenu",
               new ArgData[] {
                   new ArgData(int.class, "featureId", AnimInstance.animToString(featureId)),
                   new ArgData(Menu.class, "menu", AnimInstance.animToString(menu))
               });
     ...
     * @param menu
    */
    //## operation onPreparePanel(int,View,Menu) 
    public boolean onPreparePanel(int featureId, View view, Menu menu) {
        try {
            animInstance().notifyMethodEntered("onPreparePanel",
               new ArgData[] {
                   new ArgData(int.class, "featureId", AnimInstance.animToString(featureId)),
                   new ArgData(View.class, "view", AnimInstance.animToString(view)),
                   new ArgData(Menu.class, "menu", AnimInstance.animToString(menu))
     ...
     * @param menu
    */
    //## operation onMenuOpened(int,Menu) 
    public boolean onMenuOpened(int featureId, Menu menu) {
        try {
            animInstance().notifyMethodEntered("onMenuOpened",
               new ArgData[] {
                   new ArgData(int.class, "featureId", AnimInstance.animToString(featureId)),
                   new ArgData(Menu.class, "menu", AnimInstance.animToString(menu))
               });
     ...
     * @param item
    */
    //## operation onMenuItemSelected(int,MenuItem) 
    public boolean onMenuItemSelected(int featureId, MenuItem item) {
        try {
            animInstance().notifyMethodEntered("onMenuItemSelected",
               new ArgData[] {
                   new ArgData(int.class, "featureId", AnimInstance.animToString(featureId)),
                   new ArgData(MenuItem.class, "item", AnimInstance.animToString(item))
               });
     ...
     * @param menu
    */
    //## operation onPanelClosed(int,Menu) 
    public void onPanelClosed(int featureId, Menu menu) {
        try {
            animInstance().notifyMethodEntered("onPanelClosed",
               new ArgData[] {
                   new ArgData(int.class, "featureId", AnimInstance.animToString(featureId)),
                   new ArgData(Menu.class, "menu", AnimInstance.animToString(menu))
               });
    ...
    */
    //## operation invalidateOptionsMenu() 
    public void invalidateOptionsMenu() {
        try {
            animInstance().notifyMethodEntered("invalidateOptionsMenu",
               new ArgData[] {
               });
     ...
     * @param menu
    */
    //## operation onCreateOptionsMenu(Menu) 
    public boolean onCreateOptionsMenu(Menu menu) {
        try {
            animInstance().notifyMethodEntered("onCreateOptionsMenu",
               new ArgData[] {
                   new ArgData(Menu.class, "menu", AnimInstance.animToString(menu))
               });
     ...
     * @param menu
    */
    //## operation onPrepareOptionsMenu(Menu) 
    public boolean onPrepareOptionsMenu(Menu menu) {
        try {
            animInstance().notifyMethodEntered("onPrepareOptionsMenu",
               new ArgData[] {
                   new ArgData(Menu.class, "menu", AnimInstance.animToString(menu))
               });
     ...
     * @param item
    */
    //## operation onOptionsItemSelected(MenuItem) 
    public boolean onOptionsItemSelected(MenuItem item) {
        try {
            animInstance().notifyMethodEntered("onOptionsItemSelected",
               new ArgData[] {
                   new ArgData(MenuItem.class, "item", AnimInstance.animToString(item))
               });
     ...
     *         false otherwise.
    */
    //## operation onNavigateUp() 
    public boolean onNavigateUp() {
        try {
            animInstance().notifyMethodEntered("onNavigateUp",
               new ArgData[] {
               });
     ...
     * @param child
    */
    //## operation onNavigateUpFromChild(Activity) 
    public boolean onNavigateUpFromChild(Activity child) {
        try {
            animInstance().notifyMethodEntered("onNavigateUpFromChild",
               new ArgData[] {
                   new ArgData(Activity.class, "child", AnimInstance.animToString(child))
               });
     ...
     * @param builder
    */
    //## operation onCreateNavigateUpTaskStack(TaskStackBuilder) 
    public void onCreateNavigateUpTaskStack(TaskStackBuilder builder) {
        try {
            animInstance().notifyMethodEntered("onCreateNavigateUpTaskStack",
               new ArgData[] {
                   new ArgData(TaskStackBuilder.class, "builder", AnimInstance.animToString(builder))
               });
     ...
     * @param builder
    */
    //## operation onPrepareNavigateUpTaskStack(TaskStackBuilder) 
    public void onPrepareNavigateUpTaskStack(TaskStackBuilder builder) {
        try {
            animInstance().notifyMethodEntered("onPrepareNavigateUpTaskStack",
               new ArgData[] {
                   new ArgData(TaskStackBuilder.class, "builder", AnimInstance.animToString(builder))
               });
     ...
     * @param menu
    */
    //## operation onOptionsMenuClosed(Menu) 
    public void onOptionsMenuClosed(Menu menu) {
        try {
            animInstance().notifyMethodEntered("onOptionsMenuClosed",
               new ArgData[] {
                   new ArgData(Menu.class, "menu", AnimInstance.animToString(menu))
               });
    ...
    */
    //## operation openOptionsMenu() 
    public void openOptionsMenu() {
        try {
            animInstance().notifyMethodEntered("openOptionsMenu",
               new ArgData[] {
               });
    ...
    */
    //## operation closeOptionsMenu() 
    public void closeOptionsMenu() {
        try {
            animInstance().notifyMethodEntered("closeOptionsMenu",
               new ArgData[] {
               });
     ...
     * @param menuInfo
    */
    //## operation onCreateContextMenu(ContextMenu,View,ContextMenu.ContextMenuInfo) 
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        try {
            animInstance().notifyMethodEntered("onCreateContextMenu",
               new ArgData[] {
                   new ArgData(ContextMenu.class, "menu", AnimInstance.animToString(menu)),
                   new ArgData(View.class, "v", AnimInstance.animToString(v)),
                   new ArgData(ContextMenu.ContextMenuInfo.class, "menuInfo", AnimInstance.animToString(menuInfo))
               });
     ...
     * @param view
    */
    //## operation registerForContextMenu(View) 
    public void registerForContextMenu(View view) {
        try {
            animInstance().notifyMethodEntered("registerForContextMenu",
               new ArgData[] {
                   new ArgData(View.class, "view", AnimInstance.animToString(view))
               });
     ...
     * @param view
    */
    //## operation unregisterForContextMenu(View) 
    public void unregisterForContextMenu(View view) {
        try {
            animInstance().notifyMethodEntered("unregisterForContextMenu",
               new ArgData[] {
                   new ArgData(View.class, "view", AnimInstance.animToString(view))
               });
     ...
     * @param view
    */
    //## operation openContextMenu(View) 
    public void openContextMenu(View view) {
        try {
            animInstance().notifyMethodEntered("openContextMenu",
               new ArgData[] {
                   new ArgData(View.class, "view", AnimInstance.animToString(view))
               });
    ...
    */
    //## operation closeContextMenu() 
    public void closeContextMenu() {
        try {
            animInstance().notifyMethodEntered("closeContextMenu",
               new ArgData[] {
               });
     ...
     * @param item
    */
    //## operation onContextItemSelected(MenuItem) 
    public boolean onContextItemSelected(MenuItem item) {
        try {
            animInstance().notifyMethodEntered("onContextItemSelected",
               new ArgData[] {
                   new ArgData(MenuItem.class, "item", AnimInstance.animToString(item))
               });
     ...
     * @param menu
    */
    //## operation onContextMenuClosed(Menu) 
    public void onContextMenuClosed(Menu menu) {
        try {
            animInstance().notifyMethodEntered("onContextMenuClosed",
               new ArgData[] {
                   new ArgData(Menu.class, "menu", AnimInstance.animToString(menu))
               });
    ...
    */
    @Deprecated
    //## operation onCreateDialog(int) 
    protected Dialog  onCreateDialog(int id) {
        try {
            animInstance().notifyMethodEntered("onCreateDialog",
               new ArgData[] {
                   new ArgData(int.class, "id", AnimInstance.animToString(id))
               });
    ...
    */
    @Deprecated
    //## operation onCreateDialog(int,Bundle) 
    ...
    */
    @Deprecated
    //## operation onPrepareDialog(int,Dialog) 
    protected void onPrepareDialog(int id, Dialog dialog) {
        try {
            animInstance().notifyMethodEntered("onPrepareDialog",
               new ArgData[] {
                   new ArgData(int.class, "id", AnimInstance.animToString(id)),
                   new ArgData(Dialog.class, "dialog", AnimInstance.animToString(dialog))
               });
    ...
    */
    @Deprecated
    //## operation onPrepareDialog(int,Dialog,Bundle) 
    ...
    */
    @Deprecated
    //## operation showDialog(int) 
    public final void showDialog(int id) {
        try {
            animInstance().notifyMethodEntered("showDialog",
               new ArgData[] {
                   new ArgData(int.class, "id", AnimInstance.animToString(id))
               });
    ...
    */
    @Deprecated
    //## operation showDialog(int,Bundle) 
    ...
    */
    @Deprecated
    //## operation dismissDialog(int) 
    public final void dismissDialog(int id) {
        try {
            animInstance().notifyMethodEntered("dismissDialog",
               new ArgData[] {
                   new ArgData(int.class, "id", AnimInstance.animToString(id))
               });
     ...
     * @param id
    */
    //## operation missingDialog(int) 
    private IllegalArgumentException  missingDialog(int id) {
        try {
            animInstance().notifyMethodEntered("missingDialog",
               new ArgData[] {
                   new ArgData(int.class, "id", AnimInstance.animToString(id))
               });
    ...
    */
    @Deprecated
    //## operation removeDialog(int) 
    public final void removeDialog(int id) {
        try {
            animInstance().notifyMethodEntered("removeDialog",
               new ArgData[] {
                   new ArgData(int.class, "id", AnimInstance.animToString(id))
               });
    ...
    */
    //## operation onSearchRequested() 
    public boolean onSearchRequested() {
        try {
            animInstance().notifyMethodEntered("onSearchRequested",
               new ArgData[] {
               });
     ...
     * @param globalSearch
    */
    //## operation startSearch(String,boolean,Bundle,boolean) 
    public void startSearch(String initialQuery, boolean selectInitialQuery, Bundle appSearchData, boolean globalSearch) {
        try {
            animInstance().notifyMethodEntered("startSearch",
               new ArgData[] {
                   new ArgData(String.class, "initialQuery", AnimInstance.animToString(initialQuery)),
                   new ArgData(boolean.class, "selectInitialQuery", AnimInstance.animToString(selectInitialQuery)),
                   new ArgData(Bundle.class, "appSearchData", AnimInstance.animToString(appSearchData)),
                   new ArgData(boolean.class, "globalSearch", AnimInstance.animToString(globalSearch))
               });
     ...
     * @param appSearchData
    */
    //## operation triggerSearch(String,Bundle) 
    public void triggerSearch(String query, Bundle appSearchData) {
        try {
            animInstance().notifyMethodEntered("triggerSearch",
               new ArgData[] {
                   new ArgData(String.class, "query", AnimInstance.animToString(query)),
                   new ArgData(Bundle.class, "appSearchData", AnimInstance.animToString(appSearchData))
               });
     ...
     * @param get
    */
    //## operation takeKeyEvents(boolean) 
    public void takeKeyEvents(boolean get) {
        try {
            animInstance().notifyMethodEntered("takeKeyEvents",
               new ArgData[] {
                   new ArgData(boolean.class, "get", AnimInstance.animToString(get))
               });
     ...
     * @param featureId
    */
    //## operation requestWindowFeature(int) 
    public final boolean requestWindowFeature(int featureId) {
        try {
            animInstance().notifyMethodEntered("requestWindowFeature",
               new ArgData[] {
                   new ArgData(int.class, "featureId", AnimInstance.animToString(featureId))
               });
     ...
     * @param resId
    */
    //## operation setFeatureDrawableResource(int,int) 
    public final void setFeatureDrawableResource(int featureId, int resId) {
        try {
            animInstance().notifyMethodEntered("setFeatureDrawableResource",
               new ArgData[] {
                   new ArgData(int.class, "featureId", AnimInstance.animToString(featureId)),
                   new ArgData(int.class, "resId", AnimInstance.animToString(resId))
               });
     ...
     * @param uri
    */
    //## operation setFeatureDrawableUri(int,Uri) 
    public final void setFeatureDrawableUri(int featureId, Uri uri) {
        try {
            animInstance().notifyMethodEntered("setFeatureDrawableUri",
               new ArgData[] {
                   new ArgData(int.class, "featureId", AnimInstance.animToString(featureId)),
                   new ArgData(Uri.class, "uri", AnimInstance.animToString(uri))
               });
     ...
     * @param drawable
    */
    //## operation setFeatureDrawable(int,Drawable) 
    public final void setFeatureDrawable(int featureId, Drawable drawable) {
        try {
            animInstance().notifyMethodEntered("setFeatureDrawable",
               new ArgData[] {
                   new ArgData(int.class, "featureId", AnimInstance.animToString(featureId)),
                   new ArgData(Drawable.class, "drawable", AnimInstance.animToString(drawable))
               });
     ...
     * @param alpha
    */
    //## operation setFeatureDrawableAlpha(int,int) 
    public final void setFeatureDrawableAlpha(int featureId, int alpha) {
        try {
            animInstance().notifyMethodEntered("setFeatureDrawableAlpha",
               new ArgData[] {
                   new ArgData(int.class, "featureId", AnimInstance.animToString(featureId)),
                   new ArgData(int.class, "alpha", AnimInstance.animToString(alpha))
               });
    ...
    */
    //## operation getLayoutInflater() 
    public LayoutInflater  getLayoutInflater() {
        try {
            animInstance().notifyMethodEntered("getLayoutInflater",
               new ArgData[] {
               });
    ...
    */
    //## operation getMenuInflater() 
    public MenuInflater  getMenuInflater() {
        try {
            animInstance().notifyMethodEntered("getMenuInflater",
               new ArgData[] {
               });
    ...
    */
    @Override
    //## operation onApplyThemeResource(Resources.Theme,int,boolean) 
    protected void onApplyThemeResource(Resources.Theme theme, int resid, boolean first) {
        try {
            animInstance().notifyMethodEntered("onApplyThemeResource",
               new ArgData[] {
                   new ArgData(Resources.Theme.class, "theme", AnimInstance.animToString(theme)),
                   new ArgData(int.class, "resid", AnimInstance.animToString(resid)),
                   new ArgData(boolean.class, "first", AnimInstance.animToString(first))
               });
     ...
     * @param requestCode
    */
    //## operation startActivityForResult(Intent,int) 
    public void startActivityForResult(Intent intent, int requestCode) {
        try {
            animInstance().notifyMethodEntered("startActivityForResult",
               new ArgData[] {
                   new ArgData(Intent.class, "intent", AnimInstance.animToString(intent)),
                   new ArgData(int.class, "requestCode", AnimInstance.animToString(requestCode))
               });
     ...
     * @param options
    */
    //## operation startActivityForResult(Intent,int,Bundle) 
        ...
        try {
            animInstance().notifyMethodEntered("startActivityForResult",
               new ArgData[] {
                   new ArgData(Intent.class, "intent", AnimInstance.animToString(intent)),
                   new ArgData(int.class, "requestCode", AnimInstance.animToString(requestCode)),
                   new ArgData(Bundle.class, "options", AnimInstance.animToString(options))
               });
     ...
     * @param user
    */
    //## operation startActivityAsUser(Intent,UserHandle) 
    public void startActivityAsUser(Intent intent, UserHandle user) {
        try {
            animInstance().notifyMethodEntered("startActivityAsUser",
               new ArgData[] {
                   new ArgData(Intent.class, "intent", AnimInstance.animToString(intent)),
                   new ArgData(UserHandle.class, "user", AnimInstance.animToString(user))
               });
     ...
     * @param user
    */
    //## operation startActivityAsUser(Intent,Bundle,UserHandle) 
     ...
     * @param extraFlags
    */
    //## operation startIntentSenderForResult(IntentSender,int,Intent,int,int,int) 
    public void startIntentSenderForResult(IntentSender intent, int requestCode, Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags) throws IntentSender.SendIntentException {
        try {
            animInstance().notifyMethodEntered("startIntentSenderForResult",
               new ArgData[] {
                   new ArgData(IntentSender.class, "intent", AnimInstance.animToString(intent)),
                   new ArgData(int.class, "requestCode", AnimInstance.animToString(requestCode)),
                   new ArgData(Intent.class, "fillInIntent", AnimInstance.animToString(fillInIntent)),
                   new ArgData(int.class, "flagsMask", AnimInstance.animToString(flagsMask)),
                   new ArgData(int.class, "flagsValues", AnimInstance.animToString(flagsValues)),
                   new ArgData(int.class, "extraFlags", AnimInstance.animToString(extraFlags))
               });
     ...
     * @param options
    */
    //## operation startIntentSenderForResult(IntentSender,int,Intent,int,int,int,Bundle) 
     ...
     * @param options
    */
    //## operation startIntentSenderForResultInner(IntentSender,int,Intent,int,int,Activity,Bundle) 
    private void startIntentSenderForResultInner(IntentSender intent, int requestCode, Intent fillInIntent, int flagsMask, int flagsValues, Activity activity, Bundle options) throws IntentSender.SendIntentException {
        try {
            animInstance().notifyMethodEntered("startIntentSenderForResultInner",
               new ArgData[] {
                   new ArgData(IntentSender.class, "intent", AnimInstance.animToString(intent)),
                   new ArgData(int.class, "requestCode", AnimInstance.animToString(requestCode)),
                   new ArgData(Intent.class, "fillInIntent", AnimInstance.animToString(fillInIntent)),
                   new ArgData(int.class, "flagsMask", AnimInstance.animToString(flagsMask)),
                   new ArgData(int.class, "flagsValues", AnimInstance.animToString(flagsValues)),
                   new ArgData(Activity.class, "activity", AnimInstance.animToString(activity)),
                   new ArgData(Bundle.class, "options", AnimInstance.animToString(options))
               });
    ...
    */
    @Override
    //## operation startActivity(Intent) 
    public void startActivity(Intent intent) {
        try {
            animInstance().notifyMethodEntered("startActivity",
               new ArgData[] {
                   new ArgData(Intent.class, "intent", AnimInstance.animToString(intent))
               });
    ...
    */
    @Override
    //## operation startActivity(Intent,Bundle) 
    ...
    */
    @Override
    //## operation startActivities(Intent[]) 
    public void startActivities(Intent[] intents) {
        try {
            animInstance().notifyMethodEntered("startActivities",
               new ArgData[] {
                   new ArgData(Intent[].class, "intents", AnimInstance.animToString(intents))
               });
    ...
    */
    @Override
    //## operation startActivities(Intent[],Bundle) 
     ...
     * @param extraFlags
    */
    //## operation startIntentSender(IntentSender,Intent,int,int,int) 
    public void startIntentSender(IntentSender intent, Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags) throws IntentSender.SendIntentException {
        try {
            animInstance().notifyMethodEntered("startIntentSender",
               new ArgData[] {
                   new ArgData(IntentSender.class, "intent", AnimInstance.animToString(intent)),
                   new ArgData(Intent.class, "fillInIntent", AnimInstance.animToString(fillInIntent)),
                   new ArgData(int.class, "flagsMask", AnimInstance.animToString(flagsMask)),
     ...
     * @param options
    */
    //## operation startIntentSender(IntentSender,Intent,int,int,int,Bundle) 
     ...
     * @param requestCode
    */
    //## operation startActivityIfNeeded(Intent,int) 
    public boolean startActivityIfNeeded(Intent intent, int requestCode) {
        try {
            animInstance().notifyMethodEntered("startActivityIfNeeded",
               new ArgData[] {
                   new ArgData(Intent.class, "intent", AnimInstance.animToString(intent)),
                   new ArgData(int.class, "requestCode", AnimInstance.animToString(requestCode))
               });
     ...
     * @param options
    */
    //## operation startActivityIfNeeded(Intent,int,Bundle) 
     ...
     * @param intent
    */
    //## operation startNextMatchingActivity(Intent) 
    public boolean startNextMatchingActivity(Intent intent) {
        try {
            animInstance().notifyMethodEntered("startNextMatchingActivity",
               new ArgData[] {
                   new ArgData(Intent.class, "intent", AnimInstance.animToString(intent))
               });
     ...
     * @param options
    */
    //## operation startNextMatchingActivity(Intent,Bundle) 
     ...
     * @param requestCode
    */
    //## operation startActivityFromChild(Activity,Intent,int) 
    public void startActivityFromChild(Activity child, Intent intent, int requestCode) {
        try {
            animInstance().notifyMethodEntered("startActivityFromChild",
               new ArgData[] {
                   new ArgData(Activity.class, "child", AnimInstance.animToString(child)),
                   new ArgData(Intent.class, "intent", AnimInstance.animToString(intent)),
                   new ArgData(int.class, "requestCode", AnimInstance.animToString(requestCode))
     ...
     * @param options
    */
    //## operation startActivityFromChild(Activity,Intent,int,Bundle) 
     ...
     * @param requestCode
    */
    //## operation startActivityFromFragment(Fragment,Intent,int) 
    public void startActivityFromFragment(Fragment fragment, Intent intent, int requestCode) {
        try {
            animInstance().notifyMethodEntered("startActivityFromFragment",
               new ArgData[] {
                   new ArgData(Fragment.class, "fragment", AnimInstance.animToString(fragment)),
                   new ArgData(Intent.class, "intent", AnimInstance.animToString(intent)),
                   new ArgData(int.class, "requestCode", AnimInstance.animToString(requestCode))
     ...
     * @param options
    */
    //## operation startActivityFromFragment(Fragment,Intent,int,Bundle) 
     ...
     * @param extraFlags
    */
    //## operation startIntentSenderFromChild(Activity,IntentSender,int,Intent,int,int,int) 
    public void startIntentSenderFromChild(Activity child, IntentSender intent, int requestCode, Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags) throws IntentSender.SendIntentException {
        try {
            animInstance().notifyMethodEntered("startIntentSenderFromChild",
               new ArgData[] {
                   new ArgData(Activity.class, "child", AnimInstance.animToString(child)),
                   new ArgData(IntentSender.class, "intent", AnimInstance.animToString(intent)),
                   new ArgData(int.class, "requestCode", AnimInstance.animToString(requestCode)),
     ...
     * @param options
    */
    //## operation startIntentSenderFromChild(Activity,IntentSender,int,Intent,int,int,int,Bundle) 
     ...
     * @param exitAnim
    */
    //## operation overridePendingTransition(int,int) 
    public void overridePendingTransition(int enterAnim, int exitAnim) {
        try {
            animInstance().notifyMethodEntered("overridePendingTransition",
               new ArgData[] {
                   new ArgData(int.class, "enterAnim", AnimInstance.animToString(enterAnim)),
                   new ArgData(int.class, "exitAnim", AnimInstance.animToString(exitAnim))
               });
     ...
     * @param resultCode
    */
    //## operation setResult(int) 
    public final void setResult(int resultCode) {
        try {
            animInstance().notifyMethodEntered("setResult",
               new ArgData[] {
                   new ArgData(int.class, "resultCode", AnimInstance.animToString(resultCode))
               });
     ...
     * @param data
    */
    //## operation setResult(int,Intent) 
    public final void setResult(int resultCode, Intent data) {
        try {
            animInstance().notifyMethodEntered("setResult",
               new ArgData[] {
                   new ArgData(int.class, "resultCode", AnimInstance.animToString(resultCode)),
                   new ArgData(Intent.class, "data", AnimInstance.animToString(data))
               });
    ...
    */
    //## operation getCallingPackage() 
    public String getCallingPackage() {
        try {
            animInstance().notifyMethodEntered("getCallingPackage",
               new ArgData[] {
               });
     ...
     *         reply, or null if none.
    */
    //## operation getCallingActivity() 
    public ComponentName  getCallingActivity() {
        try {
            animInstance().notifyMethodEntered("getCallingActivity",
               new ArgData[] {
               });
     ...
     * @param visible
    */
    //## operation setVisible(boolean) 
    public void setVisible(boolean visible) {
        try {
            animInstance().notifyMethodEntered("setVisible",
               new ArgData[] {
                   new ArgData(boolean.class, "visible", AnimInstance.animToString(visible))
               });
    ...
    //## operation makeVisible() 
    void makeVisible() {
        try {
            animInstance().notifyMethodEntered("makeVisible",
               new ArgData[] {
               });
     ...
     * @see #finish
    */
    //## operation isFinishing() 
    public boolean isFinishing() {
        try {
            animInstance().notifyMethodEntered("isFinishing",
               new ArgData[] {
               });
    ...
    */
    //## operation isDestroyed() 
    public boolean isDestroyed() {
        try {
            animInstance().notifyMethodEntered("isDestroyed",
               new ArgData[] {
               });
    ...
    */
    //## operation isChangingConfigurations() 
    public boolean isChangingConfigurations() {
        try {
            animInstance().notifyMethodEntered("isChangingConfigurations",
               new ArgData[] {
               });
    ...
    */
    ...
    public void recreate() {
        try {
            animInstance().notifyMethodEntered("recreate",
               new ArgData[] {
               });
    ...
    */
    ...
    public void finish() {
        try {
            animInstance().notifyMethodEntered("finish",
               new ArgData[] {
               });
     ...
     * to do so.</p>
    */
    //## operation finishAffinity() 
    public void finishAffinity() {
        try {
            animInstance().notifyMethodEntered("finishAffinity",
               new ArgData[] {
               });
     ...
     * @param child
    */
    //## operation finishFromChild(Activity) 
    public void finishFromChild(Activity child) {
        try {
            animInstance().notifyMethodEntered("finishFromChild",
               new ArgData[] {
                   new ArgData(Activity.class, "child", AnimInstance.animToString(child))
               });
     ...
     * @param requestCode
    */
    //## operation finishActivity(int) 
    public void finishActivity(int requestCode) {
        try {
            animInstance().notifyMethodEntered("finishActivity",
               new ArgData[] {
                   new ArgData(int.class, "requestCode", AnimInstance.animToString(requestCode))
               });
     ...
     * @param requestCode
    */
    //## operation finishActivityFromChild(Activity,int) 
    public void finishActivityFromChild(Activity child, int requestCode) {
        try {
            animInstance().notifyMethodEntered("finishActivityFromChild",
               new ArgData[] {
                   new ArgData(Activity.class, "child", AnimInstance.animToString(child)),
                   new ArgData(int.class, "requestCode", AnimInstance.animToString(requestCode))
               });
     ...
     * @param data
    */
    //## operation onActivityResult(int,int,Intent) 
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        try {
            animInstance().notifyMethodEntered("onActivityResult",
               new ArgData[] {
                   new ArgData(int.class, "requestCode", AnimInstance.animToString(requestCode)),
                   new ArgData(int.class, "resultCode", AnimInstance.animToString(resultCode)),
                   new ArgData(Intent.class, "data", AnimInstance.animToString(data))
     ...
     * @param flags
    */
    //## operation createPendingResult(int,Intent,int) 
    public PendingIntent  createPendingResult(int requestCode, Intent data, int flags) {
        try {
            animInstance().notifyMethodEntered("createPendingResult",
               new ArgData[] {
                   new ArgData(int.class, "requestCode", AnimInstance.animToString(requestCode)),
                   new ArgData(Intent.class, "data", AnimInstance.animToString(data)),
                   new ArgData(int.class, "flags", AnimInstance.animToString(flags))
               });
    ...
    */
    //## operation setRequestedOrientation(int) 
    public void setRequestedOrientation(int requestedOrientation) {
        try {
            animInstance().notifyMethodEntered("setRequestedOrientation",
               new ArgData[] {
                   new ArgData(int.class, "requestedOrientation", AnimInstance.animToString(requestedOrientation))
               });
     ...
     * {@link ActivityInfo#screenOrientation ActivityInfo.screenOrientation}.
    */
    //## operation getRequestedOrientation() 
    public int getRequestedOrientation() {
        try {
            animInstance().notifyMethodEntered("getRequestedOrientation",
               new ArgData[] {
               });
    ...
    */
    ...
    public int getTaskId() {
        try {
            animInstance().notifyMethodEntered("getTaskId",
               new ArgData[] {
               });
    ...
    */
    //## operation isTaskRoot() 
    public boolean isTaskRoot() {
        try {
            animInstance().notifyMethodEntered("isTaskRoot",
               new ArgData[] {
               });
     ...
     * @param nonRoot
    */
    //## operation moveTaskToBack(boolean) 
    public boolean moveTaskToBack(boolean nonRoot) {
        try {
            animInstance().notifyMethodEntered("moveTaskToBack",
               new ArgData[] {
                   new ArgData(boolean.class, "nonRoot", AnimInstance.animToString(nonRoot))
               });
    ...
    */
    //## operation getLocalClassName() 
    public String getLocalClassName() {
        try {
            animInstance().notifyMethodEntered("getLocalClassName",
               new ArgData[] {
               });
    ...
    */
    ...
    public ComponentName  getComponentName() {
        try {
            animInstance().notifyMethodEntered("getComponentName",
               new ArgData[] {
               });
     ...
     * @param mode
    */
    //## operation getPreferences(int) 
    public SharedPreferences  getPreferences(int mode) {
        try {
            animInstance().notifyMethodEntered("getPreferences",
               new ArgData[] {
                   new ArgData(int.class, "mode", AnimInstance.animToString(mode))
               });
    ...
    //## operation ensureSearchManager() 
    private void ensureSearchManager() {
        try {
            animInstance().notifyMethodEntered("ensureSearchManager",
               new ArgData[] {
               });
    ...
    */
    @Override
    //## operation getSystemService(String) 
    public Object getSystemService(String name) {
        try {
            animInstance().notifyMethodEntered("getSystemService",
               new ArgData[] {
                   new ArgData(String.class, "name", AnimInstance.animToString(name))
               });
     ...
     * @param title
    */
    //## operation setTitle(CharSequence) 
    public void setTitle(CharSequence title) {
        try {
            animInstance().notifyMethodEntered("setTitle",
               new ArgData[] {
                   new ArgData(CharSequence.class, "title", AnimInstance.animToString(title))
               });
    ...
    */
    ...
    public void setTitle(int titleId) {
        try {
            animInstance().notifyMethodEntered("setTitle",
               new ArgData[] {
                   new ArgData(int.class, "titleId", AnimInstance.animToString(titleId))
               });
     ...
     * @param textColor
    */
    //## operation setTitleColor(int) 
    public void setTitleColor(int textColor) {
        try {
            animInstance().notifyMethodEntered("setTitleColor",
               new ArgData[] {
                   new ArgData(int.class, "textColor", AnimInstance.animToString(textColor))
               });
    ...
    public final CharSequence  getTitle() {
        try {
            animInstance().notifyMethodEntered("getTitle",
               new ArgData[] {
               });
    ...
    //## operation getTitleColor() 
    public final int getTitleColor() {
        try {
            animInstance().notifyMethodEntered("getTitleColor",
               new ArgData[] {
               });
     ...
     * @param color
    */
    //## operation onTitleChanged(CharSequence,int) 
    protected void onTitleChanged(CharSequence title, int color) {
        try {
            animInstance().notifyMethodEntered("onTitleChanged",
               new ArgData[] {
                   new ArgData(CharSequence.class, "title", AnimInstance.animToString(title)),
                   new ArgData(int.class, "color", AnimInstance.animToString(color))
               });
     ...
     * @param title
    */
    //## operation onChildTitleChanged(Activity,CharSequence) 
    protected void onChildTitleChanged(Activity childActivity, CharSequence title) {
        try {
            animInstance().notifyMethodEntered("onChildTitleChanged",
               new ArgData[] {
                   new ArgData(Activity.class, "childActivity", AnimInstance.animToString(childActivity)),
                   new ArgData(CharSequence.class, "title", AnimInstance.animToString(title))
               });
     ...
     * @param visible
    */
    //## operation setProgressBarVisibility(boolean) 
    public final void setProgressBarVisibility(boolean visible) {
        try {
            animInstance().notifyMethodEntered("setProgressBarVisibility",
               new ArgData[] {
                   new ArgData(boolean.class, "visible", AnimInstance.animToString(visible))
               });
     ...
     * @param visible
    */
    //## operation setProgressBarIndeterminateVisibility(boolean) 
    public final void setProgressBarIndeterminateVisibility(boolean visible) {
        try {
            animInstance().notifyMethodEntered("setProgressBarIndeterminateVisibility",
               new ArgData[] {
                   new ArgData(boolean.class, "visible", AnimInstance.animToString(visible))
               });
     ...
     * @param indeterminate
    */
    //## operation setProgressBarIndeterminate(boolean) 
    public final void setProgressBarIndeterminate(boolean indeterminate) {
        try {
            animInstance().notifyMethodEntered("setProgressBarIndeterminate",
               new ArgData[] {
                   new ArgData(boolean.class, "indeterminate", AnimInstance.animToString(indeterminate))
               });
     ...
     * @param progress
    */
    //## operation setProgress(int) 
    public final void setProgress(int progress) {
        try {
            animInstance().notifyMethodEntered("setProgress",
               new ArgData[] {
                   new ArgData(int.class, "progress", AnimInstance.animToString(progress))
               });
    ...
    */
    //## operation setSecondaryProgress(int) 
    public final void setSecondaryProgress(int secondaryProgress) {
        try {
            animInstance().notifyMethodEntered("setSecondaryProgress",
               new ArgData[] {
                   new ArgData(int.class, "secondaryProgress", AnimInstance.animToString(secondaryProgress))
               });
     ...
     * @param streamType
    */
    //## operation setVolumeControlStream(int) 
    public final void setVolumeControlStream(int streamType) {
        try {
            animInstance().notifyMethodEntered("setVolumeControlStream",
               new ArgData[] {
                   new ArgData(int.class, "streamType", AnimInstance.animToString(streamType))
               });
    ...
    */
    //## operation getVolumeControlStream() 
    public final int getVolumeControlStream() {
        try {
            animInstance().notifyMethodEntered("getVolumeControlStream",
               new ArgData[] {
               });
     ...
     * @param action
    */
    //## operation runOnUiThread(Runnable) 
    public final void runOnUiThread(Runnable action) {
        try {
            animInstance().notifyMethodEntered("runOnUiThread",
               new ArgData[] {
                   new ArgData(Runnable.class, "action", AnimInstance.animToString(action))
               });
     ...
     * @param attrs
    */
    //## operation onCreateView(String,Context,AttributeSet) 
    public View  onCreateView(String name, Context context, AttributeSet attrs) {
        try {
            animInstance().notifyMethodEntered("onCreateView",
               new ArgData[] {
                   new ArgData(String.class, "name", AnimInstance.animToString(name)),
                   new ArgData(Context.class, "context", AnimInstance.animToString(context)),
                   new ArgData(AttributeSet.class, "attrs", AnimInstance.animToString(attrs))
               });
     ...
     * @param attrs
    */
    //## operation onCreateView(View,String,Context,AttributeSet) 
    public View  onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        try {
            animInstance().notifyMethodEntered("onCreateView",
               new ArgData[] {
                   new ArgData(View.class, "parent", AnimInstance.animToString(parent)),
                   new ArgData(String.class, "name", AnimInstance.animToString(name)),
                   new ArgData(Context.class, "context", AnimInstance.animToString(context)),
                   new ArgData(AttributeSet.class, "attrs", AnimInstance.animToString(attrs))
               });
     ...
     * @param args
    */
    //## operation dump(String,FileDescriptor,PrintWriter,String[]) 
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        try {
            animInstance().notifyMethodEntered("dump",
               new ArgData[] {
                   new ArgData(String.class, "prefix", AnimInstance.animToString(prefix)),
                   new ArgData(FileDescriptor.class, "fd", AnimInstance.animToString(fd)),
                   new ArgData(PrintWriter.class, "writer", AnimInstance.animToString(writer)),
                   new ArgData(String[].class, "args", AnimInstance.animToString(args))
               });
     ...
     * @param args
    */
    //## operation dumpInner(String,FileDescriptor,PrintWriter,String[]) 
    void dumpInner(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        try {
            animInstance().notifyMethodEntered("dumpInner",
               new ArgData[] {
                   new ArgData(String.class, "prefix", AnimInstance.animToString(prefix)),
                   new ArgData(FileDescriptor.class, "fd", AnimInstance.animToString(fd)),
                   new ArgData(PrintWriter.class, "writer", AnimInstance.animToString(writer)),
     ...
     * @param view
    */
    //## operation dumpViewHierarchy(String,PrintWriter,View) 
    private void dumpViewHierarchy(String prefix, PrintWriter writer, View view) {
        try {
            animInstance().notifyMethodEntered("dumpViewHierarchy",
               new ArgData[] {
                   new ArgData(String.class, "prefix", AnimInstance.animToString(prefix)),
                   new ArgData(PrintWriter.class, "writer", AnimInstance.animToString(writer)),
                   new ArgData(View.class, "view", AnimInstance.animToString(view))
     ...
     * @hide
    */
    //## operation isImmersive() 
    public boolean isImmersive() {
        try {
            animInstance().notifyMethodEntered("isImmersive",
               new ArgData[] {
               });
     ...
     * @param i
    */
    //## operation setImmersive(boolean) 
    public void setImmersive(boolean i) {
        try {
            animInstance().notifyMethodEntered("setImmersive",
               new ArgData[] {
                   new ArgData(boolean.class, "i", AnimInstance.animToString(i))
               });
     ...
     * @param callback
    */
    //## operation startActionMode(ActionMode.Callback) 
    public ActionMode  startActionMode(ActionMode.Callback callback) {
        try {
            animInstance().notifyMethodEntered("startActionMode",
               new ArgData[] {
                   new ArgData(ActionMode.Callback.class, "callback", AnimInstance.animToString(callback))
               });
     ...
     * @param callback
    */
    //## operation onWindowStartingActionMode(ActionMode.Callback) 
    public ActionMode  onWindowStartingActionMode(ActionMode.Callback callback) {
        try {
            animInstance().notifyMethodEntered("onWindowStartingActionMode",
               new ArgData[] {
                   new ArgData(ActionMode.Callback.class, "callback", AnimInstance.animToString(callback))
               });
     ...
     * @param mode
    */
    //## operation onActionModeStarted(ActionMode) 
    public void onActionModeStarted(ActionMode mode) {
        try {
            animInstance().notifyMethodEntered("onActionModeStarted",
               new ArgData[] {
                   new ArgData(ActionMode.class, "mode", AnimInstance.animToString(mode))
               });
     ...
     * @param mode
    */
    //## operation onActionModeFinished(ActionMode) 
    public void onActionModeFinished(ActionMode mode) {
        try {
            animInstance().notifyMethodEntered("onActionModeFinished",
               new ArgData[] {
                   new ArgData(ActionMode.class, "mode", AnimInstance.animToString(mode))
               });
     ...
     * @param targetIntent
    */
    //## operation shouldUpRecreateTask(Intent) 
    public boolean shouldUpRecreateTask(Intent targetIntent) {
        try {
            animInstance().notifyMethodEntered("shouldUpRecreateTask",
               new ArgData[] {
                   new ArgData(Intent.class, "targetIntent", AnimInstance.animToString(targetIntent))
               });
     ...
     * @param upIntent
    */
    //## operation navigateUpTo(Intent) 
    public boolean navigateUpTo(Intent upIntent) {
        try {
            animInstance().notifyMethodEntered("navigateUpTo",
               new ArgData[] {
                   new ArgData(Intent.class, "upIntent", AnimInstance.animToString(upIntent))
               });
     ...
     * @param upIntent
    */
    //## operation navigateUpToFromChild(Activity,Intent) 
    public boolean navigateUpToFromChild(Activity child, Intent upIntent) {
        try {
            animInstance().notifyMethodEntered("navigateUpToFromChild",
               new ArgData[] {
                   new ArgData(Activity.class, "child", AnimInstance.animToString(child)),
                   new ArgData(Intent.class, "upIntent", AnimInstance.animToString(upIntent))
               });
    ...
    */
    //## operation getParentActivityIntent() 
    public Intent  getParentActivityIntent() {
        try {
            animInstance().notifyMethodEntered("getParentActivityIntent",
               new ArgData[] {
               });
     ...
     * @param parent
    */
    //## operation setParent(Activity) 
    final void setParent(Activity parent) {
        try {
            animInstance().notifyMethodEntered("setParent",
               new ArgData[] {
                   new ArgData(Activity.class, "parent", AnimInstance.animToString(parent))
               });
     ...
     * @param config
    */
    //## operation attach(Context,ActivityThread,Instrumentation,IBinder,Application,Intent,ActivityInfo,CharSequence,Activity,String,Activity.NonConfigurationInstances,Configuration) 
    final void attach(Context context, ActivityThread aThread, Instrumentation instr, IBinder token, Application application, Intent intent, ActivityInfo info, CharSequence title, Activity parent, String id, Activity.NonConfigurationInstances lastNonConfigurationInstances, Configuration config) {
        try {
            animInstance().notifyMethodEntered("attach",
               new ArgData[] {
                   new ArgData(Context.class, "context", AnimInstance.animToString(context)),
                   new ArgData(ActivityThread.class, "aThread", AnimInstance.animToString(aThread)),
                   new ArgData(Instrumentation.class, "instr", AnimInstance.animToString(instr)),
                   new ArgData(IBinder.class, "token", AnimInstance.animToString(token)),
                   new ArgData(Application.class, "application", AnimInstance.animToString(application)),
                   new ArgData(Intent.class, "intent", AnimInstance.animToString(intent)),
                   new ArgData(ActivityInfo.class, "info", AnimInstance.animToString(info)),
                   new ArgData(CharSequence.class, "title", AnimInstance.animToString(title)),
                   new ArgData(Activity.class, "parent", AnimInstance.animToString(parent)),
                   new ArgData(String.class, "id", AnimInstance.animToString(id)),
                   new ArgData(Activity.NonConfigurationInstances.class, "lastNonConfigurationInstances", AnimInstance.animToString(lastNonConfigurationInstances)),
                   new ArgData(Configuration.class, "config", AnimInstance.animToString(config))
               });
     ...
     * @param config
    */
    //## operation attach(Context,ActivityThread,Instrumentation,IBinder,int,Application,Intent,ActivityInfo,CharSequence,Activity,String,Activity.NonConfigurationInstances,Configuration) 
    final void attach(Context context, ActivityThread aThread, Instrumentation instr, IBinder token, int ident, Application application, Intent intent, ActivityInfo info, CharSequence title, Activity parent, String id, Activity.NonConfigurationInstances lastNonConfigurationInstances, Configuration config) {
        try {
            animInstance().notifyMethodEntered("attach",
               new ArgData[] {
                   new ArgData(Context.class, "context", AnimInstance.animToString(context)),
                   ...
                   new ArgData(Instrumentation.class, "instr", AnimInstance.animToString(instr)),
                   new ArgData(IBinder.class, "token", AnimInstance.animToString(token)),
                   new ArgData(int.class, "ident", AnimInstance.animToString(ident)),
                   new ArgData(Application.class, "application", AnimInstance.animToString(application)),
                   new ArgData(Intent.class, "intent", AnimInstance.animToString(intent)),
                   new ArgData(ActivityInfo.class, "info", AnimInstance.animToString(info)),
                   new ArgData(CharSequence.class, "title", AnimInstance.animToString(title)),
     ...
     * @hide 
    */
    //## operation getActivityToken() 
    public final IBinder  getActivityToken() {
        try {
            animInstance().notifyMethodEntered("getActivityToken",
               new ArgData[] {
               });
     ...
     * @param icicle
    */
    //## operation performCreate(Bundle) 
    final void performCreate(Bundle icicle) {
        try {
            animInstance().notifyMethodEntered("performCreate",
               new ArgData[] {
                   new ArgData(Bundle.class, "icicle", AnimInstance.animToString(icicle))
               });
    ...
    //## operation performStart() 
    final void performStart() {
        try {
            animInstance().notifyMethodEntered("performStart",
               new ArgData[] {
               });
    ...
    //## operation performRestart() 
    final void performRestart() {
        try {
            animInstance().notifyMethodEntered("performRestart",
               new ArgData[] {
               });
    ...
    //## operation performResume() 
    final void performResume() {
        try {
            animInstance().notifyMethodEntered("performResume",
               new ArgData[] {
               });
    ...
    //## operation performPause() 
    final void performPause() {
        try {
            animInstance().notifyMethodEntered("performPause",
               new ArgData[] {
               });
    ...
    //## operation performUserLeaving() 
    final void performUserLeaving() {
        try {
            animInstance().notifyMethodEntered("performUserLeaving",
               new ArgData[] {
               });
    ...
    final void performStop() {
        try {
            animInstance().notifyMethodEntered("performStop",
               new ArgData[] {
               });
    ...
    //## operation performDestroy() 
    final void performDestroy() {
        try {
            animInstance().notifyMethodEntered("performDestroy",
               new ArgData[] {
               });
    ...
    */
    ...
    public final boolean isResumed() {
        try {
            animInstance().notifyMethodEntered("isResumed",
               new ArgData[] {
               });
     ...
     * @param data
    */
    //## operation dispatchActivityResult(String,int,int,Intent) 
    void dispatchActivityResult(String who, int requestCode, int resultCode, Intent data) {
        try {
            animInstance().notifyMethodEntered("dispatchActivityResult",
               new ArgData[] {
                   new ArgData(String.class, "who", AnimInstance.animToString(who)),
                   new ArgData(int.class, "requestCode", AnimInstance.animToString(requestCode)),
                   new ArgData(int.class, "resultCode", AnimInstance.animToString(resultCode)),
    ...
    public  Activity() {
        try {
            animInstance().notifyConstructorEntered(animClassActivity.getUserClass(),
               new ArgData[] {
               });
    ...
    //## class Activity::ManagedDialog 
    private static class ManagedDialog implements Animated {
        ...
        Dialog mDialog;		//## attribute mDialog 
        
        Bundle mArgs;		//## link mArgs 
        ...
        public  ManagedDialog() {
            try {
                animInstance().notifyConstructorEntered(animClassActivity$ManagedDialog.getUserClass(),
                   new ArgData[] {
                   });
        ...
        public AnimClass getAnimClass() { 
            return animClassActivity$ManagedDialog; 
        }
        /**  see com.ibm.rational.rhapsody.animation.Animated interface */
        ...
        public void addAttributes(AnimAttributes msg) {
            ...
            msg.add("mDialog", mDialog);
        }
        /**  see com.ibm.rational.rhapsody.animation.Animated interface */
        public void addRelations(AnimRelations msg) {
            
            msg.add("mArgs", false, true, mArgs);
        }
        /** An inner class added as instrumentation for animation */
        public class Animate extends AnimInstance { 
            public  Animate() { 
                super(ManagedDialog.this); 
            } 
            public void addAttributes(AnimAttributes msg) {
                ManagedDialog.this.addAttributes(msg);
            }
            public void addRelations(AnimRelations msg) {
                ManagedDialog.this.addRelations(msg);
            }
    ...
    //## class Activity::NonConfigurationInstances 
    final static class NonConfigurationInstances implements Animated {
        ...
        Object activity;		//## attribute activity 
        
        HashMap<String, Object> children;		//## attribute children 
        
        ArrayList<Fragment> fragments;		//## attribute fragments 
        
        HashMap<String, LoaderManagerImpl> loaders;		//## attribute loaders 
        ...
        public  NonConfigurationInstances() {
            try {
                animInstance().notifyConstructorEntered(animClassActivity$NonConfigurationInstances.getUserClass(),
                   new ArgData[] {
                   });
        ...
        /**  see com.ibm.rational.rhapsody.animation.Animated interface */
        public AnimClass getAnimClass() { 
            return animClassActivity$NonConfigurationInstances; 
        }
        /**  see com.ibm.rational.rhapsody.animation.Animated interface */
        public Object getFieldValue(java.lang.reflect.Field f, Object userInstance) { 
             Object obj = null;
        ...
        public void addAttributes(AnimAttributes msg) {
            ...
            msg.add("activity", activity);
            msg.add("children", children);
            msg.add("fragments", fragments);
            msg.add("loaders", loaders);
        }
        /**  see com.ibm.rational.rhapsody.animation.Animated interface */
        public void addRelations(AnimRelations msg) {
        ...
        public class Animate extends AnimInstance { 
            public  Animate() { 
                super(NonConfigurationInstances.this); 
            } 
            public void addAttributes(AnimAttributes msg) {
                NonConfigurationInstances.this.addAttributes(msg);
            }
            public void addRelations(AnimRelations msg) {
                NonConfigurationInstances.this.addRelations(msg);
            }
    ...
    //## class Activity::ManagedCursor 
    private final static class ManagedCursor implements Animated {
        ...
        private final Cursor mCursor;		//## attribute mCursor 
        
        private boolean mReleased;		//## attribute mReleased 
        
        private boolean mUpdated;		//## attribute mUpdated 
         ...
         * @param cursor
        */
        //## operation ManagedCursor(Cursor) 
         ManagedCursor(Cursor cursor) {
            try {
                animInstance().notifyConstructorEntered(animClassActivity$ManagedCursor.getUserClass(),
                   new ArgData[] {
                       new ArgData(Cursor.class, "cursor", AnimInstance.animToString(cursor))
                   });
        ...
        /**  see com.ibm.rational.rhapsody.animation.Animated interface */
        public AnimClass getAnimClass() { 
            return animClassActivity$ManagedCursor; 
        }
        /**  see com.ibm.rational.rhapsody.animation.Animated interface */
        public Object getFieldValue(java.lang.reflect.Field f, Object userInstance) { 
             Object obj = null;
        ...
        public void addAttributes(AnimAttributes msg) {
            ...
            msg.add("mCursor", mCursor);
            msg.add("mReleased", mReleased);
            msg.add("mUpdated", mUpdated);
        }
        /**  see com.ibm.rational.rhapsody.animation.Animated interface */
        public void addRelations(AnimRelations msg) {
        ...
        public class Animate extends AnimInstance { 
            public  Animate() { 
                super(ManagedCursor.this); 
            } 
            public void addAttributes(AnimAttributes msg) {
                ManagedCursor.this.addAttributes(msg);
            }
            public void addRelations(AnimRelations msg) {
                ManagedCursor.this.addRelations(msg);
            }
    ...
    public void addAttributes(AnimAttributes msg) {
        ...
        msg.add("TAG", TAG);
        msg.add("DEBUG_LIFECYCLE", DEBUG_LIFECYCLE);
        msg.add("RESULT_CANCELED", RESULT_CANCELED);
        msg.add("RESULT_OK", RESULT_OK);
        msg.add("RESULT_FIRST_USER", RESULT_FIRST_USER);
        msg.add("FRAGMENTS_TAG", FRAGMENTS_TAG);
        msg.add("WINDOW_HIERARCHY_TAG", WINDOW_HIERARCHY_TAG);
        msg.add("SAVED_DIALOG_IDS_KEY", SAVED_DIALOG_IDS_KEY);
        msg.add("SAVED_DIALOGS_TAG", SAVED_DIALOGS_TAG);
        msg.add("SAVED_DIALOG_KEY_PREFIX", SAVED_DIALOG_KEY_PREFIX);
        msg.add("SAVED_DIALOG_ARGS_KEY_PREFIX", SAVED_DIALOG_ARGS_KEY_PREFIX);
        msg.add("mManagedDialogs", mManagedDialogs);
        msg.add("mInstrumentation", mInstrumentation);
        msg.add("mIdent", mIdent);
        msg.add("mEmbeddedID", mEmbeddedID);
        msg.add("mApplication", mApplication);
        msg.add("mMainThread", mMainThread);
        msg.add("mCalled", mCalled);
        msg.add("mCheckedForLoaderManager", mCheckedForLoaderManager);
        msg.add("mLoadersStarted", mLoadersStarted);
        msg.add("mResumed", mResumed);
        msg.add("mStopped", mStopped);
        msg.add("mFinished", mFinished);
        msg.add("mStartedActivity", mStartedActivity);
        msg.add("mDestroyed", mDestroyed);
        msg.add("mTemporaryPause", mTemporaryPause);
        msg.add("mChangingConfigurations", mChangingConfigurations);
        msg.add("mConfigChangeFlags", mConfigChangeFlags);
        msg.add("mSearchManager", mSearchManager);
        msg.add("mDecor", mDecor);
        msg.add("mWindowAdded", mWindowAdded);
        msg.add("mVisibleFromServer", mVisibleFromServer);
        msg.add("mVisibleFromClient", mVisibleFromClient);
        msg.add("mActionBar", mActionBar);
        msg.add("mEnableDefaultActionBarUp", mEnableDefaultActionBarUp);
        msg.add("mTitle", mTitle);
        msg.add("mTitleColor", mTitleColor);
        msg.add("mFragments", mFragments);
        msg.add("mContainer", mContainer);
        msg.add("mAllLoaderManagers", mAllLoaderManagers);
        msg.add("mLoaderManager", mLoaderManager);
        msg.add("mManagedCursors", mManagedCursors);
        msg.add("mResultCode", mResultCode);
        msg.add("mResultData", mResultData);
        msg.add("mTitleReady", mTitleReady);
        msg.add("mDefaultKeyMode", mDefaultKeyMode);
        msg.add("mDefaultKeySsb", mDefaultKeySsb);
        msg.add("FOCUSED_STATE_SET", FOCUSED_STATE_SET);
        msg.add("mInstanceTracker", mInstanceTracker);
        msg.add("mUiThread", mUiThread);
        msg.add("mHandler", mHandler);
        msg.add("DEFAULT_KEYS_DISABLE", DEFAULT_KEYS_DISABLE);
        msg.add("DEFAULT_KEYS_DIALER", DEFAULT_KEYS_DIALER);
        msg.add("DEFAULT_KEYS_SHORTCUT", DEFAULT_KEYS_SHORTCUT);
        msg.add("DEFAULT_KEYS_SEARCH_LOCAL", DEFAULT_KEYS_SEARCH_LOCAL);
        msg.add("DEFAULT_KEYS_SEARCH_GLOBAL", DEFAULT_KEYS_SEARCH_GLOBAL);
    }
    /**  see com.ibm.rational.rhapsody.animation.Animated interface */
    public void addRelations(AnimRelations msg) {
        
        msg.add("mToken", false, true, mToken);
        msg.add("mIntent", false, true, mIntent);
        msg.add("mComponent", false, true, mComponent);
        msg.add("mActivityInfo", false, true, mActivityInfo);
        msg.add("mParent", false, true, mParent);
        msg.add("mCurrentConfig", false, true, mCurrentConfig);
        msg.add("mMenuInflater", false, true, mMenuInflater);
        msg.add("mLastNonConfigurationInstances", false, true, mLastNonConfigurationInstances);
        msg.add("mWindow", false, true, mWindow);
        msg.add("mWindowManager", false, true, mWindowManager);
    }
    /** An inner class added as instrumentation for animation */
    public class Animate extends AnimInstance { 
        public  Animate() { 
        ...
        public void addAttributes(AnimAttributes msg) {
            Activity.this.addAttributes(msg);
        }
        public void addRelations(AnimRelations msg) {
            Activity.this.addRelations(msg);
        }
